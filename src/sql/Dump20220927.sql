...
INSERT INTO `user` VALUES ('86c3119f-1922-44a9-9a60-7625c7c24530','adminabaso','$2a$10$lYj4hyHxcK9viqhyuqxtIeSBFKXd.lA0QFA3DzWklzJabFFXLnHeS');
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `login`(
	IN __username varchar(10),
    IN __password varchar(255)
)
BEGIN
  DECLARE _username varchar(10) DEFAULT __username;
  DECLARE _password varchar(255) DEFAULT __password;
  SELECT * FROM user
...
-- Dump completed on 2022-09-27 17:53:12
